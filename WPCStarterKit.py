...
class SocialMediaPresence:
    ...
    def searchSocialMediaLinks(self,website,text,level='1'):
        if website != '':
        ...
        try:
            ...
            print("The length of the scrapped content: %s characters" % str(len(text)))            
            ...
            p = HTMLParserBS()
            p.output_list=p.extractURLs(text)
